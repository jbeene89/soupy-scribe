...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'Model cards per agent', status: 'available', detail: 'Provider, version, role, and known failure modes documented for every perspective in the SOUPY pipeline.' },
      ...
      { name: 'Hallucination rate metrics', status: 'in_progress', detail: 'Validation harness in build; first published precision/recall numbers expected with pilot #1.' },
      { name: 'NIST AI RMF alignment statement', status: 'in_progress' },
